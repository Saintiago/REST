...
abstract class BaseStatus extends BaseObject  implements Persistent {
	 ...
	 * related Queues from storage. If this Status is new, it will return
		...
		if ($this->collQueues === null) {
			if ($this->isNew()) {
			   $this->collQueues = array();
				...
				$criteria->add(QueuePeer::STATUS, $this->id);
	 ...
	 */
	public function getQueuesJoinVideo($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(StatusPeer::DATABASE_NAME);
		}
		...
		if ($this->collQueues === null) {
			if ($this->isNew()) {
				...
				$this->collQueues = QueuePeer::doSelectJoinVideo($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
