...
abstract class BaseUsers extends BaseObject  implements Persistent {
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 5; // 5 = UsersPeer::NUM_COLUMNS - UsersPeer::NUM_LAZY_LOAD_COLUMNS).
	 ...
	 * related Videos from storage. If this Users is new, it will return
		...
		if ($this->collVideos === null) {
			if ($this->isNew()) {
			   $this->collVideos = array();
				...
				$criteria->add(VideoPeer::USER_ID, $this->id);
